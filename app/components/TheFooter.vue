<template>
  <footer class="bg-background-dark border-t border-border-dark py-12 px-4 md:px-10">
    <div class="max-w-[1280px] mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
      <div class="flex items-center gap-2 text-white">
        ...
        <span class="font-bold text-lg">FutureUs</span>
      </div>
      <div class="flex gap-6 text-sm text-text-secondary">
        <NuxtLink to="#" class="hover:text-primary transition-colors">Privasi</NuxtLink>
        <NuxtLink to="#" class="hover:text-primary transition-colors">Syarat & Ketentuan</NuxtLink>
        <NuxtLink to="#" class="hover:text-primary transition-colors">Hubungi Kami</NuxtLink>
      </div>
      <div class="text-sm text-white/40">
        © 2023 FutureUs Indonesia.
      </div>
    </div>
  </footer>
</template>
